...
//Url of the GetDetails action in the PHP application(http://localhost:8086/getDetails). Learn more about authorize server [here](https://help.syncfusion.com/bold-bi/embedded-bi/javascript/authorize-server)
const authorizationUrl = "http://localhost/rest/authorizeserver.php";
...
class DashboardListing extends React.Component {
   ...
   renderDashboard() {
    this.dashboard= BoldBI.create({
      ...
      environment: ((environment==="enterprise") || (environment ==="onpremise"))? BoldBI.Environment.Enterprise:BoldBI.Environment.Cloud,
      width:"100%",
